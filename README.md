...
![AXI](https://img.shields.io/badge/AXI-1E90FF?style=for-the-badge)
...
- Design Digital e Microeletrônica
- SoCs e integração com barramentos (AXI, OBI, AHB e APB)
- Confiabilidade em Hardware
- Aceleração por hardware (co-processadores)
...
- **Linguagens:** SystemVerilog, C/C++, Python
- **Verificação:** UVM, TLM, RISC-DV
- **Protocolos:** APB, OBI, AXI, I2S, SDIO, Timers
- **EDA Tools:** Cadence (Xcelium, SimVision, Genus, Innovus, Modus, Conformal)
- **SoC/FPGA:** LiteX
- **Ambiente:** Linux (Rocky Linux)
...
- LinkedIn: *[(Tulio-Rafael)](https://www.linkedin.com/in/t%C3%BAlio-rafael-de-aguiar-tavares-a85557218/)*
- Email: *tulio.tavares@ee.ufcg.edu.br*
